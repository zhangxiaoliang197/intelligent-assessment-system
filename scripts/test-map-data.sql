...
CREATE TABLE `test_aircraft_trajectory` (
    ...
    `aircraft_type`  VARCHAR(20)   NOT NULL COMMENT '机型：歼-20/歼-16/运-20/空警-500',
...
INSERT INTO `test_aircraft_trajectory` (`aircraft_id`, `aircraft_name`, `aircraft_type`, `seq`, `lng`, `lat`, `altitude`, `speed`, `heading`, `record_time`, `fuel_remaining`, `status`) VALUES
('KJ500-01', '空警-01', '空警-500',  1, 126.64, 45.75,    0,    0, 200, '2025-08-10 07:00:00', 100, '起飞'),
('KJ500-01', '空警-01', '空警-500',  2, 125.32, 43.90, 3500,  380, 210, '2025-08-10 07:25:00',  96, '爬升'),
('KJ500-01', '空警-01', '空警-500',  3, 123.43, 41.80, 7000,  520, 215, '2025-08-10 07:55:00',  89, '爬升'),
('KJ500-01', '空警-01', '空警-500',  4, 121.50, 41.00, 8000,  600, 235, '2025-08-10 08:20:00',  82, '巡航'),
('KJ500-01', '空警-01', '空警-500',  5, 117.20, 39.13, 8000,  620, 230, '2025-08-10 09:00:00',  72, '巡航'),
('KJ500-01', '空警-01', '空警-500',  6, 117.00, 36.67, 8000,  620, 205, '2025-08-10 09:35:00',  63, '巡航'),
('KJ500-01', '空警-01', '空警-500',  7, 113.65, 34.76, 8000,  610, 215, '2025-08-10 10:15:00',  52, '巡航'),
('KJ500-01', '空警-01', '空警-500',  8, 114.30, 30.59, 8000,  600, 188, '2025-08-10 11:05:00',  39, '巡航'),
('KJ500-01', '空警-01', '空警-500',  9, 112.97, 28.20, 5500,  500, 200, '2025-08-10 11:45:00',  29, '下降'),
('KJ500-01', '空警-01', '空警-500', 10, 113.27, 23.13,    0,    0, 190, '2025-08-10 12:30:00',  15, '降落');

-- 航线2：运-20 上海→乌鲁木齐（华东→西北，10个轨迹点）
-- 途经：南京→合肥→郑州→西安→兰州→酒泉→哈密→吐鲁番→乌鲁木齐
INSERT INTO `test_aircraft_trajectory` (`aircraft_id`, `aircraft_name`, `aircraft_type`, `seq`, `lng`, `lat`, `altitude`, `speed`, `heading`, `record_time`, `fuel_remaining`, `status`) VALUES
('Y20-001', '鲲鹏-01', '运-20',  1, 121.47, 31.23,    0,    0, 290, '2025-08-10 08:00:00', 100, '起飞'),
('Y20-001', '鲲鹏-01', '运-20',  2, 118.78, 32.06, 3500,  400, 300, '2025-08-10 08:25:00',  94, '爬升'),
('Y20-001', '鲲鹏-01', '运-20',  3, 117.28, 31.86, 7000,  550, 295, '2025-08-10 08:45:00',  87, '爬升'),
('Y20-001', '鲲鹏-01', '运-20',  4, 113.65, 34.76, 9000,  700, 310, '2025-08-10 09:25:00',  74, '巡航'),
('Y20-001', '鲲鹏-01', '运-20',  5, 108.95, 34.27, 9000,  720, 300, '2025-08-10 10:05:00',  60, '巡航'),
('Y20-001', '鲲鹏-01', '运-20',  6, 103.83, 36.06, 9000,  730, 305, '2025-08-10 10:55:00',  46, '巡航'),
('Y20-001', '鲲鹏-01', '运-20',  7,  98.50, 39.70, 9000,  720, 320, '2025-08-10 11:45:00',  33, '巡航'),
('Y20-001', '鲲鹏-01', '运-20',  8,  93.50, 42.80, 9000,  710, 325, '2025-08-10 12:25:00',  22, '巡航'),
('Y20-001', '鲲鹏-01', '运-20',  9,  89.20, 42.90, 5500,  550, 310, '2025-08-10 13:00:00',  15, '下降'),
('Y20-001', '鲲鹏-01', '运-20', 10,  87.62, 43.82,    0,    0, 290, '2025-08-10 13:30:00',  12, '降落');

-- 航线3：歼-20 北京→昆明（华北→西南，8个轨迹点）
-- 途经：保定→太原→西安→汉中→成都→宜宾→昆明
INSERT INTO `test_aircraft_trajectory` (`aircraft_id`, `aircraft_name`, `aircraft_type`, `seq`, `lng`, `lat`, `altitude`, `speed`, `heading`, `record_time`, `fuel_remaining`, `status`) VALUES
('J20-001', '威龙-01', '歼-20',  1, 116.40, 39.90,    0,    0, 220, '2025-08-10 09:00:00', 100, '起飞'),
('J20-001', '威龙-01', '歼-20',  2, 115.50, 38.80, 5000,  650, 225, '2025-08-10 09:12:00',  95, '爬升'),
('J20-001', '威龙-01', '歼-20',  3, 112.55, 37.87, 9000,  900, 240, '2025-08-10 09:30:00',  86, '爬升'),
('J20-001', '威龙-01', '歼-20',  4, 108.95, 34.27, 10000, 1100, 235, '2025-08-10 10:00:00',  71, '巡航'),
('J20-001', '威龙-01', '歼-20',  5, 107.00, 33.00, 10000, 1100, 215, '2025-08-10 10:20:00',  60, '巡航'),
('J20-001', '威龙-01', '歼-20',  6, 104.07, 30.67, 10000, 1050, 210, '2025-08-10 10:50:00',  47, '巡航'),
('J20-001', '威龙-01', '歼-20',  7, 104.60, 28.80, 6000,  800, 200, '2025-08-10 11:15:00',  36, '下降'),
('J20-001', '威龙-01', '歼-20',  8, 102.72, 25.04,    0,    0, 195, '2025-08-10 11:55:00',  24, '降落');

-- 航线4：歼-16 拉萨→福州（西南高原→东南沿海，9个轨迹点）
-- 途经：林芝→昌都→成都→重庆→恩施→长沙→南昌→福州
INSERT INTO `test_aircraft_trajectory` (`aircraft_id`, `aircraft_name`, `aircraft_type`, `seq`, `lng`, `lat`, `altitude`, `speed`, `heading`, `record_time`, `fuel_remaining`, `status`) VALUES
('J16-001', '潜龙-01', '歼-16',  1,  91.13, 29.65,    0,    0,  90, '2025-08-10 07:00:00', 100, '起飞'),
('J16-001', '潜龙-01', '歼-16',  2,  94.36, 29.65, 4000,  550,  95, '2025-08-10 07:25:00',  94, '爬升'),
('J16-001', '潜龙-01', '歼-16',  3,  97.20, 31.20, 7000,  700, 100, '2025-08-10 07:50:00',  85, '爬升'),
('J16-001', '潜龙-01', '歼-16',  4, 104.07, 30.67, 9000,  900, 105, '2025-08-10 08:40:00',  68, '巡航'),
('J16-001', '潜龙-01', '歼-16',  5, 106.55, 29.57, 9000,  880, 120, '2025-08-10 09:05:00',  58, '巡航'),
('J16-001', '潜龙-01', '歼-16',  6, 109.50, 30.30, 9000,  860, 125, '2025-08-10 09:30:00',  49, '巡航'),
('J16-001', '潜龙-01', '歼-16',  7, 112.97, 28.20, 9000,  850, 130, '2025-08-10 10:00:00',  38, '巡航'),
('J16-001', '潜龙-01', '歼-16',  8, 115.86, 28.68, 6000,  700, 120, '2025-08-10 10:30:00',  27, '下降'),
('J16-001', '潜龙-01', '歼-16',  9, 119.30, 26.08,    0,    0, 110, '2025-08-10 11:15:00',  15, '降落');

-- 航线5：运-20 呼和浩特→南宁（华北→华南中线，8个轨迹点）
-- 途经：太原→郑州→南阳→武汉→长沙→桂林→南宁
INSERT INTO `test_aircraft_trajectory` (`aircraft_id`, `aircraft_name`, `aircraft_type`, `seq`, `lng`, `lat`, `altitude`, `speed`, `heading`, `record_time`, `fuel_remaining`, `status`) VALUES
('Y20-002', '鲲鹏-02', '运-20',  1, 111.75, 40.84,    0,    0, 180, '2025-08-10 08:30:00', 100, '起飞'),
('Y20-002', '鲲鹏-02', '运-20',  2, 112.55, 37.87, 4000,  420, 190, '2025-08-10 08:55:00',  94, '爬升'),
('Y20-002', '鲲鹏-02', '运-20',  3, 113.65, 34.76, 7000,  580, 195, '2025-08-10 09:25:00',  84, '爬升'),
('Y20-002', '鲲鹏-02', '运-20',  4, 112.50, 33.00, 9000,  700, 205, '2025-08-10 09:45:00',  76, '巡航'),
('Y20-002', '鲲鹏-02', '运-20',  5, 114.30, 30.59, 9000,  720, 195, '2025-08-10 10:15:00',  65, '巡航'),
('Y20-002', '鲲鹏-02', '运-20',  6, 112.97, 28.20, 9000,  710, 190, '2025-08-10 10:50:00',  53, '巡航'),
('Y20-002', '鲲鹏-02', '运-20',  7, 110.28, 25.28, 5500,  550, 195, '2025-08-10 11:25:00',  41, '下降'),
('Y20-002', '鲲鹏-02', '运-20',  8, 108.32, 22.82,    0,    0, 190, '2025-08-10 12:00:00',  28, '降落');
...
INSERT INTO `assessment`.`ass_dataset` (`id`, `name`, `description`, `database_id`, `table_name`, `sql_text`, `records`, `create_time`, `update_time`)
VALUES (
    'test_map_radar',
    '雷达站信息数据集',
...
VALUES (
    'test_map_trajectory',
    '飞机飞行轨迹数据集',
    '记录5架飞机（空警-500、运-20×2、歼-20、歼-16）共45条飞行轨迹点位信息。航线覆盖全国六大区域：哈尔滨→广州（东北→华南）、上海→乌鲁木齐（华东→西北）、北京→昆明（华北→西南）、拉萨→福州（高原→东南沿海）、呼和浩特→南宁（华北→华南中线）。所有坐标基于真实城市经纬度，均在陆地上。每个点位包含经纬度坐标、高度、速度、航向、飞行状态等属性。可用于地图路线连线（route）、轨迹回放、点位属性标注（marker）等场景。',
    'test_db_001',
